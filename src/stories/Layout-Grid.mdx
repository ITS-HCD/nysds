...
<div className="nys-grid-row border">
...
<h3><a id="large-gutter"></a>Gap sizes</h3>
<p>Use a sized gap modifier on <code>nys-grid-row</code> to set a fixed gutter. Values follow the NYS size ramp:</p>
<ul>
  <li><code>nys-grid-gap-1px</code> — 1px</li>
  <li><code>nys-grid-gap-2px</code> — 2px</li>
  <li><code>nys-grid-gap-50</code> — 4px</li>
  <li><code>nys-grid-gap-100</code> — 8px</li>
  <li><code>nys-grid-gap-150</code> — 12px</li>
  <li><code>nys-grid-gap-200</code> — 16px</li>
  <li><code>nys-grid-gap-250</code> — 20px</li>
  <li><code>nys-grid-gap-300</code> — 24px</li>
  <li><code>nys-grid-gap-400</code> — 32px</li>
  <li><code>nys-grid-gap-500</code> — 40px</li>
  <li><code>nys-grid-gap-600</code> — 48px</li>
  <li><code>nys-grid-gap-700</code> — 56px</li>
  <li><code>nys-grid-gap-800</code> — 64px</li>
  <li><code>nys-grid-gap-1200</code> — 96px</li>
</ul>
<h4>Uniform Gaps</h4>
<div className="nys-grid-row border-left">
  <div className="nys-grid-col-1 border-right">
...
<h4>Different Horizontal and Vertical Gaps</h4>
<div className="nys-grid-row border-left">
  <div className="nys-grid-col-1 border-right">
    <div className="text-center">1</div>
  </div>
...
<div className="nys-grid-row nys-grid-gap-x-200 nys-grid-gap-y-600">
  <div className="nys-grid-col-4">
    <div>.nys-grid-col-4</div>
  </div>
  <div className="nys-grid-col-4">
...
```html
<div class="nys-grid-row  nys-grid-gap-x-200 nys-grid-gap-y-600">
  <div class="nys-grid-col-4">
    <div>.nys-grid-col-4</div>
  </div>
  <div class="nys-grid-col-4">
