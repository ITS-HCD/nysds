...
The `@nys-excelsior/styles` package is available on npm and can be used in any application, even without Excelsior’s web components. This flexibility means you can use the design system’s tokens, themes, and utilities across different platforms.
...
You can also download the CSS files directly from the [`@nys-excelsior/styles` npm page](https://www.npmjs.com/org/nys-excelsior) and include them in your project:
