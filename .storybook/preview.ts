...
// No "default" icon-library override needed: since PRD Phase 3 the standard
// NYSDS set is self-contained JS data (nys-icon.library.ts) — no URL
// resolution, no per-icon fetch, no staticDirs dependency.
