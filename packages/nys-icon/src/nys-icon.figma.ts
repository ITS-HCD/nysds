...
figma.connect("<FIGMA_ICONS_CALENDAR_MONTH>", { example: () => html`calendar_month` });
...
figma.connect("<FIGMA_ICONS_CHEVRON_DOWN>", { example: () => html`chevron_down` });
figma.connect("<FIGMA_ICONS_CHEVRON_UP>", { example: () => html`chevron_up` });
figma.connect("<FIGMA_ICONS_DOWNLOAD_DONE>", { example: () => html`download_done` });
figma.connect("<FIGMA_ICONS_UPLOAD_FILE>", { example: () => html`upload_file` });
figma.connect("<FIGMA_ICONS_DRIVE_FOLDER_UPLOAD>", { example: () => html`drive_folder_upload` });
...
figma.connect("<FIGMA_ICONS_GOOGLE_PLAY>", { example: () => html`google_play` });
...
figma.connect("<FIGMA_ICONS_EDIT_SQUARE>", { example: () => html`edit_square` });
figma.connect("<FIGMA_ICONS_RSS>", { example: () => html`rss` });
figma.connect("<FIGMA_ICONS_VISIBILITY>", { example: () => html`visibility` });
figma.connect("<FIGMA_ICONS_VISIBILITY_OFF>", { example: () => html`visibility_off` });
...
figma.connect("<FIGMA_ICONS_CHECK_CIRCLE>", { example: () => html`check_circle` });
figma.connect("<FIGMA_ICONS_INFO>", { example: () => html`info` });
figma.connect("<FIGMA_ICONS_ERROR>", { example: () => html`error` });
figma.connect("<FIGMA_ICONS_EMERGENCY_HOME>", { example: () => html`emergency_home` });
...
figma.connect("<FIGMA_ICONS_CORONAVIRUS>", { example: () => html`coronavirus` });
...
figma.connect("<FIGMA_ICONS_ARROW_FORWARD>", { example: () => html`arrow_forward` });
figma.connect("<FIGMA_ICONS_ARROW_DOWNWARD>", { example: () => html`arrow_downward` });
figma.connect("<FIGMA_ICONS_ARROW_UPWARD>", { example: () => html`arrow_upward` });
figma.connect("<FIGMA_ICONS_OPEN_IN_NEW>", { example: () => html`open_in_new` });
figma.connect("<FIGMA_ICONS_SMS>", { example: () => html`sms` });
figma.connect("<FIGMA_ICONS_NOTIFICATIONS>", { example: () => html`notifications` });