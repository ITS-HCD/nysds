...
<Meta
  of={NysGlobalFooterStories}
  title="Components/GlobalFooter/Documentation"
/>
...
<div className="nys-grid-row nys-grid-gap-1">
  ...
  <p className="pill pill--uikit">
    <a
      target="_blank"
      href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu?node-id=4003-64216"
    >
      View in Figma
    </a>
  </p>
...
>
  {" "}
  <nys-icon name="info" size="xl"></nys-icon> Minimize the number of links to
  keep users focused and avoid distractions{" "}
</div>
...
>
  ...
  See the example below for the proper column structure and recommended
  hierarchy.
</div>
...
<div className="nys-grid-row nys-grid-gap-lg">
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--do">
      ...
      Include essential links and information users need site-wide. - Keep the
      design consistent and unobtrusive. - Minimize the number of links.
    </div>
  </div>
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--dont">
      ### <nys-icon name="error" color="var(--nys-color-danger)" /> Don't -
      Overcrowd the footer with unnecessary links. - Use it for critical alerts
