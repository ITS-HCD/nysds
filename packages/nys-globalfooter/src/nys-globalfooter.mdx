...
<div style={{ display: 'flex', gap: '10px', verticalAlign: 'middle', alignItems: 'center' }}>  <nys-icon name="info"></nys-icon> Minimize the number of links to keep users focused and avoid distractions </div>
