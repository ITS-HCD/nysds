...
## With Links
To add links, place an unordered list (`<ul>`) inside the `nys-globalfooter` slot. Each list item (`<li>`) should contain an anchor (`<a href="">`) linking to the desired destination.
