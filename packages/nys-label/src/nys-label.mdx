...
<div className="nys-grid-row nys-grid-gap-lg">
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--do">
      ...
      Use the required flag only if the required prop is added to the form
      field. - Use clear wording for what information the user should input in
      the form field.
    </div>
  </div>
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--dont">
      ...
      the label alone or without a form field.
    </div>
  </div>
</div>
