...
<div className="nys-grid-row nys-grid-gap-100">
  ...
  <nys-badge
    ...
    intent="success"
  ></nys-badge>
  <p className="pill pill--uikit"><a href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu?node-id=4303-1514" target="_blank">View in Figma</a></p>
</div>
...
- **Focus management:** After scrolling to the top, focus moves to `<body>`, placing the user before the skip-navigation link. This lets keyboard users re-activate the skip link to jump back to main content, and works reliably regardless of whether the page uses `<main>` or heading landmarks.
