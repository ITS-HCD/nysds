...
- **Focus management:** After scrolling to the top, focus is automatically moved to the `<main>` element (if present), first heading, or document element. This ensures keyboard navigation continues naturally from the top of the page.
