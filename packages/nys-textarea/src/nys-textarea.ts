			...
			<label class="nys-textarea">
				...
				html` <div class="nys-textarea__text">
					<div class="nys-textarea__requiredwrapper">
						...
						${this.required ? html`<div class="nys-textarea__required">*</div>` : ""}
					</div>
					<slot class="nys-textarea__description" name="description"> ${this.description} </slot>
				</div>`}
				<div class="nys-textarea__requiredwrapper">
					<textarea class="nys-textarea__textarea ${this.size} ${this.resize}" name=${this.name} id=${this.id} ?disabled=${this.disabled} ?required=${this.required} ?readonly=${this.readonly} aria-disabled="${this.disabled}" .value=${this.value} placeholder=${this.placeholder} maxlength=${ifDefined(this.maxlength)} rows=${ifDefined(this.rows)} form=${ifDefined(this.form)} @input=${this._handleInput} @focus="${this._handleFocus}" @blur="${this._handleBlur}"></textarea>
					${this.required && !this.label ? html`<div class="nys-textarea__required">*</div>` : ""}
				</div>
				${this.errorMessage &&
