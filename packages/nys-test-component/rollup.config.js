...
export default {
  ...
  output: [
    {
      file: "dist/nys-test-component.esm.js", // ESM build (for modern browsers)
      format: "es",
      sourcemap: true,
      banner,
    },
    {
      file: "dist/nys-test-component.cjs.js", // CommonJS build (for Node.js)
      format: "cjs",
      sourcemap: true,
      banner,
    },
    {
      file: "dist/nys-test-component.js", // Univeral Module Definition (UMD) build (for older browsers)
      format: "umd",
