...
<div className="nys-grid-row nys-grid-gap-1">
  ...
  <p className="pill pill--uikit">
    <a
      target="_blank"
      href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu?node-id=3981-10268"
    >
      View in Figma
    </a>
  </p>
...
>
  {" "}
  <nys-icon size="xl" name="info"></nys-icon> The Universal Navigation Footer
...
<div className="nys-grid-row nys-grid-gap-lg">
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--do">
      ...
      Use `nys-unavfooter` to provide consistent access to essential links
      across all sites. - Place it only at the bottom of the page as the final
      footer.
    </div>
  </div>
  <div className="nys-mobile-lg:nys-grid-col">
