...
## Options
The `<nys-skipnav>` component adds a hidden "Skip to main content" link that appears on Tab, allowing keyboard and screen reader users to jump directly to the main content. \
By default, `href` is set to `href="#main-content"`, but you can change it to match the **id** of your main content container.
