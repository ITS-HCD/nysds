...
export class NysTextinput extends LitElement {
	...
	updated(changedProperties: Map<string | number | symbol, unknown>) {
		if (changedProperties.has("width")) {
			this.width = NysTextinput.VALID_WIDTHS.includes(this.width) ? this.width : "full";
		}
	}
			...
			<div class="nys-textinput">
				...
				html` <div class="nys-textinput__text">
					<div class="nys-textinput__requiredwrapper">
						...
						${this.required ? html`<label class="nys-textinput__required">*</label>` : ""}
					</div>
