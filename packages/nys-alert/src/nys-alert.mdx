...
<p class="pill pill--stable">Stable</p>

<p class="pill pill--uikit"><a href="https://www.figma.com/design/0ogYpymUPQQfhELthntNbt/%F0%9F%92%A0-NYS-%2F-Excelsior-Components-(Alpha)?node-id=866-814&p=f&m=dev">View in Figma</a></p>
