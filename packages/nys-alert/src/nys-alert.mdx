...
### Custom Description
Add descriptive content to your alert using the `description` prop or the `slot="description"` feature.
Use the description prop for simple text, or leverage `slot="description"` for advanced HTML customizations, such as links or styled text.
