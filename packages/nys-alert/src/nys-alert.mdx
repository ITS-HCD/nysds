...
<div className="nys-grid-row nys-grid-gap-100">
  ...
  <nys-badge
    ...
    intent="success"
  ></nys-badge>
  <p className="pill pill--uikit"><a target="_blank" href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu?node-id=3981-8845">View in Figma</a></p>
</div>
...
<div className="nys-grid-row nys-grid-gap-400">
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--do">
      ...
      - Use the appropriate `type` (e.g., `info`, `success`, `warning`, or `danger`) to match the intent of the alert.
  ...
  <div className="nys-mobile-lg:nys-grid-col">
    <div className="usage-card usage-card--dont">
      ...
      - Use icons or types that don’t clearly communicate the purpose of the alert.
    </div>
  </div>
</div>
