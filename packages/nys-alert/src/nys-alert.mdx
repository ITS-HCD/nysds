...
### Dismissable
All alerts include an optional `dismissable` boolean property. When enabled, it adds a close button in the top-right corner, allowing users to dismiss the alert.
<Canvas of={NysAlertStories.Dismissable} />
