...
<nys-alert
  ...
  ‼️ YOU MUST CLOSE OUT OF THE MODAL IN ORDER TO RE-ACCESS THE SCROLLBAR 🔥
</nys-alert>
<br/>
...
<Canvas of={NysModalStories.ButtonSlot} />

### Mandatory Action 
If the modal requires users to take action and shouldn’t be dismissible, use the `mandatory` prop.
