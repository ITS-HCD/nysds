...
<table>
    ...
    <tbody>
    <tr>
        <th colSpan="2">`nys-radiobutton`</th>
    </tr>
    <tr>
        <td>`nys-radiobutton`</td>
        <td>Wrapper of the entire component</td>
    </tr>
    <tr>
        <td>`nys-radiobutton__radio`</td>
        <td>The native radiobutton component</td>
    </tr>
    <tr>
        <td>
          `nys-radiobutton__text` <br/>
          `nys-radiobutton__label`<br/>
          `nys-radiobutton__description`
        </td>
        <td>Text that appears next to the radiobutton</td>
    </tr>
    <tr>
        <td>
          `nys-radiobutton__requiredwrapper`<br/>
          `nys-radiobutton__required`
        </td>
        <td>Displays the asterisk if the component is required</td>
    </tr>
    <th colSpan="2">`nys-radiogroup`</th>
    <tr>
        <td>`nys-radiogroup`</td>
        <td>Wrapper of the entire component</td>
    </tr>
    <tr>
        <td>`nys-radiobutton__error`</td>
