...
<p className="pill uikit"><a target="_blank" href="https://www.figma.com/design/0ogYpymUPQQfhELthntNbt/%F0%9F%92%A0-NYS-%2F-Excelsior-Components-(Alpha)?node-id=2191-4934&p=f&t=cZ4tR1bBvLjvWG2s-0">Get the UI kit</a></p>
