...
<p className="pill pill--uikit">
	<a href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu?node-id=4739-106" target="_blank">View in Figma</a>
</p>
=======
<div class="nys-grid-row nys-grid-gap-1">
  ...
  ></nys-badge>
  <p className="pill pill--uikit">
    <a href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu/branch/s6RRas2SHWImnD7PMgmWJ8/%F0%9F%92%A0-NYS-Design-System?node-id=4821-4576&m=dev" target="_blank">View in Figma</a>
  </p>
</div>
>>>>>>> 6c7bd0d9f0d283e46395f2dc5f28a28abd3351b6
