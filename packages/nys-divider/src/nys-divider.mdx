...
### Subtle
The  `subtle` attribute can be used to create a more subtle divider that is less visually prominent. This is useful when you want to separate content without drawing too much attention to the divider itself.
<Canvas of={NysDividerStories.Subtle} />
