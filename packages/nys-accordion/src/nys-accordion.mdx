...
<p className="pill pill--uikit">
	<a href="https://www.figma.com/design/U2QpuSUXRTxbgG64Fzi9bu/%F0%9F%92%A0-NYS-Design-System?node-id=4309-106&p=f&t=ubWEB1T4qS7wzxZk-0" target="_blank">View in Figma</a>
</p>
...
1. `nys-accordionToggle`: Emitted when the accordion is clicked.
...
// Listen for the '"nys-accordionToggle' event
accordion.addEventListener("nys-accordionToggle", () => {
