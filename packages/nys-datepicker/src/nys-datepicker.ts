...
/**
 * Form-associated, accessible date picker with custom calendar UI.
 * Falls back to native date input on Safari and mobile devices.
 *
 * @summary Accessible date picker with calendar popup and native fallback.
