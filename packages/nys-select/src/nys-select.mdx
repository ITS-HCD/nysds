...
### Variants
??? Not sure what applies here -Emily
...
<table>
    ...
    <tr>
        <td>`nys-select`</td>
        <td>The div that wraps the entire `nys-select` component</td>
    </tr>
    <tr>
        <td>`nys-select__text`</td>
        <td>The text wrapper</td>
    </tr>
    <tr>
        <td>`nys-select__label`</td>
        <td>The label's wrapper</td>
    </tr>
    <tr>
        <td>`nys-select__description`</td>
        <td>The description's wrapper</td>
    </tr>
    <tr>
        <td>`nys-select__required`</td>
        <td>The required flag's wrapper</td>
    </tr>
    <tr>
        <td>`nys-select__requiredwrapper`</td>
        <td>Wraps the required flag with the text</td>
    </tr>
    <tr>
        <td>`nys-select__selectwrapper`</td>
        <td>Wraps the native `<select>` element</td>
    </tr>
    <tr>
        <td>`nys-select__select`</td>
        <td>The native `<select>` element</td>
    </tr>
    <tr>
        <td>`nys-select__icon`</td>
        <td>Wraps the down chevron icon</td>
    </tr>
    <tr>
        <td>`nys-select__error`</td>
        <td>The error message wrapper</td>
    </tr>
    </tbody>
</table>