...
<p className="pill pill--uikit"><a target="_blank" href="https://www.figma.com/design/0ogYpymUPQQfhELthntNbt/%F0%9F%92%A0-NYS-%2F-Excelsior-Components-(Alpha)?node-id=1626-2561&p=f&m=dev">View in Figma</a></p>
...
### Variants
⚠️ Important: While optional, you may find wrapping checkboxes with `nys-checkboxgroup` helpful for multiple selections with the same checkbox name. This ensures they function as a single form control. Some of the examples below will show this.
