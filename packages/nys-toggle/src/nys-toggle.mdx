...
<p class="pill uikit"><a href="https://www.figma.com/design/0ogYpymUPQQfhELthntNbt/%F0%9F%92%A0-NYS-%2F-Excelsior-Components-(Alpha)?node-id=1626-2591&p=f&t=QF8BQ6f9JDt9M72a-0">Get the UI kit</a></p>

***

<Canvas of={NysToggleStories.Default} />
...
### When to consider something else
  - Consider using `nys-checkbox` instead toggling switch to lead to immediate action.
  - Avoid using toggle for binary option with critical consequences.
...
<table>
  ...
  <tbody>
    <tr>
      <td>`nys-toggle`</td>
      <td>Root container for the toggle component.</td>
    </tr>
    <tr>
      <td>`nys-toggle__content`</td>
      <td>Wrapper for the toggle and associated text content.</td>
    </tr>
    <tr>
      <td>`nys-toggle__toggle`</td>
      <td>Interactive switch containing the input and visual slider.</td>
    </tr>
    <tr>
      <td>`nys-toggle__text`</td>
      <td>Wrapper for the label and description text.</td>
    </tr>
    <tr>
      <td>`nys-toggle__label`</td>
      <td>Element displaying the toggle’s main label.</td>
    </tr>
  </tbody>
</table>
